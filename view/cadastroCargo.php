...
<br>
<form action="../controller/cadastroCargoController.php" method="post"> 

<div class="form-group"> 
<div class="col-md-6 offset-md-3">
  <label for="descricao" class="form-label">Descrição:</label>
  <input type="text" value="" name="descricao" class="form-control" id="" style="min-width:300px;"  placeholder="Descrição do Cargo" required>
</div>  
  <br>
