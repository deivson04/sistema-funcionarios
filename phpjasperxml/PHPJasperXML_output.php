...
use simitsdk\phpjasperxml\Exports\Pdf_driver;
use simitsdk\phpjasperxml\Exports\Xlsx_driver;
require_once ('C:\xampp\htdocs\gerenciamentoDeFuncionarios\phpjasperxml\vendor\phpoffice\phpspreadsheet\src\PhpSpreadsheet\Writer\Xlsx.php');
...
{                    
    ...
    {                
        ...
        require_once ('C:\\xampp\htdocs\\gerenciamentoDeFuncionarios\\phpjasperxml\\Exports\\'.ucfirst($type).'_driver.php');
        $classname = ucfirst($type)."_driver";
        // $this->console($this->pageproperties);die;
        if(str_contains($classname, "Pdf"))
            $this->output  = new Pdf_driver($this->pageproperties);
        else
            $this->output  = new Xlsx_driver($this->pageproperties);
